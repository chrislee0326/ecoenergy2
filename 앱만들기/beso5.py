...
#st.write('등급: '+ str(grade1))
# 매우나쁨 일 때는 이렇게 행동하세요! : 인쇄 작업, 난방, 샤워 등 일시적으로 전기를 사용해야하는 행동을 자제하세요. 이후 보통 이상 등급이 되었을 때 미루었던 일을 마무리하시기 바랍니다.
# 이 앱은 한국 전력 거래소 사이트의 실시간 전력수급현황_발전원별 발전량 데이터를 기반으로 합니다. (링크)
# 계산식: (신재생에너지 발전량/전체 발전량)*100(%)
#<작성멘트>
